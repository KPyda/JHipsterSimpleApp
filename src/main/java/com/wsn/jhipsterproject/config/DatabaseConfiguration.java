package com.wsn.jhipsterproject.config;

import com.wsn.jhipsterproject.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.wsn.jhipsterproject.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.wsn.jhipsterproject.repository.search")
